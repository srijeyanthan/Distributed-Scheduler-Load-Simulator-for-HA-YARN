...
public class MRAMSimulator extends AMSimulator {
  ...
  private AMNMCommonObject amnmRemoteStub;
  ...
  public void init(int id, int heartbeatInterval,
    ...
    Registry registry;
    try {
      //LOG.info("<><><><>>>>>>>>>>>>>>>>>>>>>>>>>>>>> Trying to get connection of remote object ");
      registry = LocateRegistry.getRegistry("127.0.0.1");
      amnmRemoteStub = (AMNMCommonObject) registry.lookup("AMNMCommonObject");
     // LOG.info("<><><><>>>>>>>>>>>>>>>>>>>>>>>>>>>>> found the object ........ :::  "+amnmRemoteStub);
  ...
  public void requestAMContainer()
    ...
    while (true) {
      ...
      if (response != null && !response.getAllocatedContainers().isEmpty()) {
        ...
        amnmRemoteStub.addNewContainer(
  ...
  protected void processResponseQueue()
    ...
    while (!responseQueue.isEmpty()) {
      ...
      if (isAMContainerRunning
        ...
        amnmRemoteStub.cleanupContainer(amContainer.getId().toString(),amContainer.getNodeId().toString());
